...
module.exports = React.createClass({
    ...
    _registerAsGuest: function(showWarning) {
        ...
        MatrixClientPeg.get().registerGuest().done(function(creds) {
            ...
            MatrixClientPeg.get().setDisplayName(QueryString.spacetracechatname);
            // call via 
            // http://localhost:8080/?spacetracechatname=test123#/room/!roEufnbMCZAbuvRshA:matrix.eclabs.de
